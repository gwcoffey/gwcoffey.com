...
Rather than use alternate tags or semantically meaningless classes to differentiate the types of asides, we rely on the *content*. This helps encourage consistency of content, and ensures that relevant information is in the content itself and not hidden away in HTML attributes.
