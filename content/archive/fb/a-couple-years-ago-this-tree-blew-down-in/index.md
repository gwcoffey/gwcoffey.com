...
Now it looks mostly normal and is taller and straighter than its sibling (planted at the same time but never broken).

If you look closely you can see the wound where the original trunk broke off, and you can just make out in the bark pattern how the whole trunk twisted. 
